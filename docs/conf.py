# -*- coding: utf-8 -*-
#
# kemmering documentation build configuration file
#
...
project = 'kemmering'
copyright = '2016, Chris Rossi <chris@archimedeanco.com>'
...
html_theme_options = {
    'github_url': 'https://github.com/chrisrossi/kemmering'
}
...
latex_documents = [
  ('index', 'kemmering.tex', 'Kemmering Documentation',
   'Chris Rossi', 'manual'),
]
